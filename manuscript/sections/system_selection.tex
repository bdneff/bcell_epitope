...
\begin{figure}[H]\centering\figorbox{hel_apo_structure.png}{0.45}
\caption{Apo HEL starting structure (RCSB \textbf{1AKI}, 1.5\,\AA{} X-ray, chain A); cartoon
coloured by secondary structure (helices purple, sheets yellow). This single apo trajectory
serves all three antibody scans.}\end{figure}
