...
disulfides. We simulate the apo enzyme from \texttt{1AKI}. Three independent antibody alanine
scans label the same antigen (Table~\ref{tab:ddg-lysozyme}): HyHEL-63 (\texttt{1DQJ}), D1.3
(\texttt{1VFB}) and HyHEL-10 (\texttt{3HFM}) --- overlapping but distinct epitopes, a useful
internal check on whether the predicted hotspots are antibody-specific. HyHEL-63 and HyHEL-10
share the K96/K97 hotspot pair, whereas D1.3 engages the opposite face (the 18--24 and 116--129
segments).
...
\caption{HEL coloured per residue by alanine-scan \ddG\ for three antibodies (shared global scale, white $=0$, red $=$ hotspot, blue $<0$; grey $=$ not scanned). HyHEL-63 and HyHEL-10 converge on the K96/K97 epitope; D1.3 marks a distinct face.}\end{figure}
