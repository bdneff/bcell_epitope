...
alanine-scan labels. Structure-image placeholders render a box until the figure is added
(see \texttt{figures/FIGURES.md}). \ddG\ values are the change in binding free energy,
$K_d$/$K_i$-derived; positive weakens binding.
...
\begin{figure}[htbp]\centering\figorbox{lysozyme_structure.png}{0.45}
\caption{Apo HEL --- relaxed apo frame from the 1AKI trajectory; cartoon coloured by secondary structure.}\end{figure}
...
\begin{figure}[htbp]\centering\figorbox{hpr_structure.png}{0.45}
\caption{Apo HPr (2JEL chain P); cartoon coloured by secondary structure.}\end{figure}
...
\begin{figure}[htbp]\centering\figorbox{vegf_structure.png}{0.45}
\caption{Apo VEGF-A homodimer (1BJ1 chains V,W); cartoon coloured by secondary structure.}\end{figure}
...
\begin{figure}[htbp]\centering\figorbox{bonta1_structure.png}{0.45}
\caption{Bont/A1 H\textsubscript{C} domain (2NYY res 872--1295); cartoon coloured by secondary structure.}\end{figure}
