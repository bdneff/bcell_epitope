...
hotspot on one face (Table~\ref{tab:ddg-ifngr}). It is a clean, rigid, single-chain
...
(Table~\ref{tab:ddg-tf}). The ectodomain is a well-folded, single-chain $\sim$200-residue
...
(Table~\ref{tab:ddg-hcmvgb}). This is our largest antigen ($\sim$566 modelled residues) and is
...
MAb3 scan (Table~\ref{tab:ddg-hgh}); the benchmark additionally carries a secondary,
