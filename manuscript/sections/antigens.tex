...
\caption{Apo HEL (1AKI); label residues highlighted. \textit{Placeholder.}}\end{figure}
...
\caption{Apo HPr (2JEL chain P). \textit{Placeholder.}}\end{figure}
...
\caption{Apo VEGF-A homodimer (1BJ1 chains V,W). \textit{Placeholder.}}\end{figure}
...
\caption{Bont/A1 H\textsubscript{C} domain (2NYY res 872--1295). \textit{Placeholder.}}\end{figure}
