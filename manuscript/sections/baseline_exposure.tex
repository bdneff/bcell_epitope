...
apo rel.\ SASA ($x$) vs.\ alanine-scan $\ddG$ ($y$); red $=$ experimentally important for binding,
grey $=$ not; the shaded band is what an exposure cutoff (rel.\ SASA $\geq 0.25$) would call epitope.
